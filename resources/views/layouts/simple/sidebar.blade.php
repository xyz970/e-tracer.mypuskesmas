		...
		<nav class="sidebar-main">
			...
			<div id="sidebar-menu">
			  <ul class="sidebar-links" id="simple-bar">
				...
				<li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="task.html"><i class="fa fa-stethoscope fa-lg icon"> </i>  <span class="link-content">Data Dokter</span></a></li>
				<li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="calendar-basic.html"><i class="fa fa-user-md fa-lg icon"> </i>  <span class="link-content">Data Poli</span></a></li>
				...
				<li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="search.html"><i class="fa fa-users fa-lg icon"> </i>  <span class="link-content">Data Petugas</span></a></li>
